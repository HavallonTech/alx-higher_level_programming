...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        self.x = x
        self.y = y
        """ self.y and self.x calls the setter and getter method as if they were private attributes
        """
        #print(self.id)
    def area(self):
    ...
    def display(self):
        """ this method displays the rectangle using the # in place of the Area as calculated
